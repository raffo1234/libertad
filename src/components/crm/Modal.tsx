...
export default function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  const modal = (
    ...
    >
      <div
        className={`w-full max-w-lg overflow-hidden border border-[#e8e3db] bg-[#faf8f5] shadow-[0_20px_60px_rgba(0,0,0,0.12)] transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${
